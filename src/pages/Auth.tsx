        ...
        >
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-sm mt-2">
              {mode === "login" ? "Acesse sua conta para comprar ou anunciar" : "Preencha seus dados para se cadastrar"}
            </p>
          </div>
          ...
          {mode === "login" && (
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="text-xs font-medium text-foreground">Sou comprador</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-xs font-medium text-foreground">Sou vendedor</span>
              </button>
            </div>
          )}
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            {mode !== "login" && (
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-card border border-border focus-within:border-primary transition-colors">
                  ...
                  <input type="text" placeholder="Seu nome" className="flex-1 bg-transparent text-foreground placeholder:text-muted-foreground outline-none text-sm" />
                </div>
              </div>
            )}
            ...
            {mode === "register-seller" && (
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-card border border-border focus-within:border-primary transition-colors">
                  ...
                  <input type="text" placeholder="Nome do seu comércio" className="flex-1 bg-transparent text-foreground placeholder:text-muted-foreground outline-none text-sm" />
                </div>
              </div>
            )}
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-card border border-border focus-within:border-primary transition-colors">
                ...
                <input type="email" placeholder="seu@email.com" className="flex-1 bg-transparent text-foreground placeholder:text-muted-foreground outline-none text-sm" />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-card border border-border focus-within:border-primary transition-colors">
                ...
                <input type={showPassword ? "text" : "password"} placeholder="••••••••" className="flex-1 bg-transparent text-foreground placeholder:text-muted-foreground outline-none text-sm" />
          ...
          <p className="text-center text-sm text-muted-foreground">
            {mode === "login" ? (
              <>
                Não tem conta?{" "}
                <button onClick={() => setMode("register-buyer")} className="text-primary font-medium hover:underline">
                  Cadastre-se
                </button>
              </>
            ) : (
